 ...
 * Url of that original destination. The {@code SavedRequest} object will remain
 * cached and be picked up when the redirected request is received (See
...
public class TestAuthenticationSuccessHandler extends
	...
	public void onAuthenticationSuccess(HttpServletRequest request,
		...
		logger.debug("#################### redirectUrl: "
				+ savedRequest.getRedirectUrl() + ", targetUrlParameter:"
				+ targetUrlParameter + ", alwaysUseDefaultTargetUrl:"
